            ...
            <thead>
              ...
              <?php
                ...
                if(isset($_POST['search'])){
                          ...
                          $sql = "SELECT * FROM purchase order by p_id desc";
                        }
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          echo "<td> Product id:" . $row["product_id"]."<br>Product name:". $row["product_name"]."</td>";
                          echo "<td>Quantity:" . $row["quantity"]."<br>Unit price:".$row["unit_price"]."<br>Date:".$row["date"]."<br>"."</td>";
                          echo "<td>Company:" . $row["company"]."</td>";
                          echo '<td> <img  height="100px" src="application/'.$row["image"].'"</td>';

                          echo '<td><a href="delete_student.php?id='.$row['p_id']. '"class="btn btn-info btn-sm">
