  ...
  <div class="content-wrapper">
    ...
    <div class="row" >
      ...
      <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin-bottom:5px;border-radius:10px;">
              <form method="post" action="other_registration_done.php" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      <label for="name">Customer type:</label>
                      <select name="customer_type" class="form-control" id="sel1">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input  type="text" name="district"  class="form-control" id="pwd">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="pwd">Upozila:</label>
                      <input  type="text" name="upozila"  class="form-control" id="pwd">
                    </div>
                  </div>
