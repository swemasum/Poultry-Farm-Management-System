...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container" >
      <div class="row">
        <h3 style="text-align:center">problematic egg supply</h3>
      </div>
    <div class="row" >


      <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin-bottom:5px;border-radius:10px;">
              <form method="post" action="supply_problem_egg_done.php" enctype="multipart/form-data">
...
if(isset($_POST['search'])){
            $search=$_POST['search'];
            $sql = "SELECT sum(quantity) as quantity FROM supply_problem_egg where name like '%$search%' or phone like '%$search%' ";

        }else if(isset($_POST['fromdate']) && isset($_POST['todate'])){
          $fromdate=$_POST['fromdate'];
          $todate=$_POST['todate'];
          if($todate!=''){
            $sql = "SELECT sum(quantity) as quantity FROM supply_problem_egg where date between '$fromdate' and '$todate' ";
          }else{
            $sql = "SELECT sum(quantity) as quantity FROM supply_problem_egg where date ='$fromdate' ";
          }
       ...
       <div class="col-md-12">
           <div class="card">
               ...
               <div class="col-md-6 col-sm-6">
                 <form class="" action="supply_problem_egg.php" method="post">
                   <div class="row">
                     <div class="col-md-5">
                       <div class="form-group ">
  ...
  function PrintElem(elem)
      ...
      <div class="table-wrapper-scroll-x" id="myDivToPrint">
        <div class="row">
          ...
          <div class="col-md-6">
            <h3>problamatic egg Stock: <?php echo $defect_egg-$total_problematic_egg_supply;  ?></h3>
          </div>
          <div class="col-md-6">
            <h3>Supplied: <?php echo $total_problematic_egg_supply;  ?></h3>
          </div>
        </div>
        <table class="table" border='1' style="width: 100% ; border:1px solid black;border-collapse: collapse;">
            <thead>
              ...
              <?php
                ...
                if(isset($_POST['search'])){
                            $search=$_POST['search'];
                            $sql = "SELECT * FROM supply_problem_egg where name like '%$search%' or phone like '%$search%' ";

                        }else if(isset($_POST['fromdate']) && isset($_POST['todate'])){
                          $fromdate=$_POST['fromdate'];
                          $todate=$_POST['todate'];
                          if($todate!=''){
                            $sql = "SELECT * FROM supply_problem_egg where date between '$fromdate' and '$todate' ";
                          }else{
                            $sql = "SELECT * FROM supply_problem_egg where date ='$fromdate' ";
                          }

}else{
                          $sql = "SELECT * FROM supply_problem_egg order by supply_problem_id desc";
                        }
            ...
            echo "<td>" . $row["date"]."</td>";
                                      ...
                                      echo "<td>" . $row["name"]."</td>";
                                        ...
                                        echo "<td>" . $row["phone"]."</td>";
                                          ...
                                          echo '<td><a title="delete" onclick="return check();" href="delete_problematic_egg.php?id='.$row['supply_problem_id']. '"class="btn btn-danger btn-sm">
                          <span class="glyphicon glyphicon-trash">
                          <a title="edit" href="edit_problem_supply.php?id='.$row['supply_problem_id']. '"class="btn btn-info btn-sm">
