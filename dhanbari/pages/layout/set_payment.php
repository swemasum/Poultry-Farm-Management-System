      ...
      <div class="row" >
        ...
        <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
              ...
              <div class="row">
                ...
                <div>
                <div class="col-md-4 col-lg-4" id="man_cont1"  style="display:none">
                  <div class="form-group"  >
                    <label for="pwd">Semester fee:</label>
          <input type="number" class="form-control" name="semester" value="">
                  </div>
                </div>
                <div class="col-md-4 col-lg-4">
                  <div class="form-group"  >
                    <label for="pwd">Admission fee:</label>
          <input type="number" class="form-control" name="admission" value="">
                  </div>
                </div>        <div class="col-md-4 col-lg-4">
                          <div class="form-group"  >
                            <label for="pwd">Emolument:</label>
                  <input type="numbernumber" class="form-control" name="emolument" value="">
                          </div>
                        </div>
                        <div class="col-md-4 col-lg-4">
                          <div class="form-group" >
                            <label for="pwd">Test Exam fee:</label>
                  <input type="number" class="form-control" name="test" value="">
                          </div>
                        </div>
                        <div class="col-md-4 col-lg-4">
                          <div class="form-group"  >
                            <label for="pwd">in course exam fee:</label>
                  <input type="number" class="form-control" name="in_course" value="">
                          </div>
                        </div>
                        <div class="col-md-4 col-lg-4">
                          <div class="form-group"  >
                            <label for="pwd">form fill-up fee:</label>
                  <input type="number" class="form-control" name="form_fill_up" value="">
                          </div>
                        </div>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          ...
                          echo "<td>" . $row["date"]."</td>";
                          echo '<td><a href="set_payment_delete.php?id='.$row['p_id']. '"class="btn btn-info btn-lg">
