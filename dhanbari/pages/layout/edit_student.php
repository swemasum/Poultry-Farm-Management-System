...
$sql = "SELECT * FROM student_info where s_id='$edit_id'";
$result = mysqli_query($conn, $sql);
$_SESSION['student_id']=$edit_id;
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="text" name="f_name" value="<?php echo $f_name; ?>" class="form-control" id="pwd">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input required type="text" name="subject" value="<?php echo $subject; ?>"  class="form-control" id="pwd">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="pwd">Roll no:</label>
                      <input required type="text" name="roll_no" value="<?php echo $roll_no; ?>" placeholder="01xxx-xxxxxx" class="form-control" id="pwd">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="pwd">Session:</label>
                      <input required type="text" name="session" value="<?php echo $session; ?>" class="form-control" id="pwd">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="pwd">Registraion-no:</label>
                      <input required type="text" name="registration" value="<?php echo $registration; ?>" class="form-control" id="pwd">
                    </div>
                  </div>
                </div>
