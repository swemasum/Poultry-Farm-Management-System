  ...
  <div class="content-wrapper">
    ...
    <div class="row" style="margin-right:30px">
      ...
      <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin-bottom:5px;border-radius:10px;">
              <form method="post" action="bird_entry_done.php" enctype="multipart/form-data">


                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="pwd">total bird Quantity:</label>
       ...
       <div class="col-md-12">
           <div class="card">
               ...
               <div class="col-md-8 col-sm-8">
                 <form class="" action="new_bird.php" method="post">
                   <div class="row">
                     <div class="col-md-5">
                       <div class="form-group ">
            ...
            <thead>
              ...
              <?php
                ...
                if(isset($_POST['search'])){
                            $search=$_POST['search'];
                            $sql = "SELECT * FROM bird where quantity like '%$search%' or dead_bird like '%$search%' ";

                        }else if(isset($_POST['fromdate']) && isset($_POST['todate'])){
                          $fromdate=$_POST['fromdate'];
                          $todate=$_POST['todate'];
                          if($todate!=''){
                            $sql = "SELECT * FROM bird where date between '$fromdate' and '$todate' ";
                          }else{
                            $sql = "SELECT * FROM bird where date ='$fromdate' ";
                          }

}else{
                          $sql = "SELECT * FROM bird order by bird_id desc";
                        }
                        $total=0;
          ...
          $age="no";
            ...
            echo "<td>" . $row["date"]."</td>";
                                      ...
                                      echo "<td>" . $row["quantity"]."</td>";
                                        echo "<td>".floor((time() - strtotime($row["date"])) / (60*60*24))."</td>";
                                          echo "<td>" .$row['narration']."</td>";
                          echo '<td><a title="delete" onclick="return check();" href="bird_delete.php?id='.$row['bird_id']. '"class="btn btn-danger btn-sm">
          <span class="glyphicon glyphicon-trash">
          <a title="edit" href="bird_edit.php?id='.$row['bird_id']. '"class="btn btn-info btn-sm">
